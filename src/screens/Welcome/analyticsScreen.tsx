...
import BaseScreen from "@junee/components/baseScreen";
import images from "@junee/images";
            ...
            bottomContainer: {
              ...
              topButton: {
                ...
                onPress: () => {
                  ...
                  Alert.alert('', "Event sent", [{ text: "Ok" }], { cancelable: false });
                }
              },
              bottomButton: {
                text: "Send event with color property",
                onPress: () => {
                  NativeModules.Junee.showColoredEventsDialog();
                }
              }
            }
          }}
